...
export const getSecciones = async (req: Request, res: Response): Promise<Response> => {

    const seccion = await getRepository(Seccion).find();
    // respuesta JSon al front
    return res.json(seccion)
};

//para crear las secciones
export const createSeccion = async (req: Request, res: Response): Promise<Response> => {
...
export const getSeccion = async (req: Request, res: Response): Promise<Response> => {
...
export const updateSeccion = async (req: Request, res: Response): Promise<Response> => {
...
export const deleteSeccion = async (req: Request, res: Response): Promise<Response> => {
